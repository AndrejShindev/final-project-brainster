...
import AcademyCard from '../../Assets/Cards/AcademyCard';
    ...
    return (
        <Row className='Academies'>
            ...
            <AcademyCard
                ...
                image='/dizajn.jpg'
                bg='rgb(27,2,40)'
                bgGradient='linear-gradient(0deg, rgba(27,2,40,0.95) 0%, rgba(74,4,112,0.5) 100%)'
            />
            <AcademyCard
                ...
                image='/marketing.jpg'
                bg='rgb(98,3,3)'
                bgGradient='linear-gradient(0deg, rgba(98,3,3,0.9) 0%, rgba(148,8,8,0.5) 100%)'
            />
            <AcademyCard
                ...
                image='/frontEnd.jpg'
                bg='rgb(224,151,23)'
                bgGradient='linear-gradient(0deg, rgba(224,151,23,0.5) 0%, rgba(241,168,6,0.5) 100%)'
            />
            <AcademyCard
                ...
                image='/backEnd.png'
                bg='rgb(5,5,5)'
                bgGradient='linear-gradient(0deg, rgba(45,47,47,0.5) 0%, rgba(114,119,120,0.5) 100%)'
            />
            <AcademyCard
                ...
                bg='rgb(13,74,22)'
                bgGradient='linear-gradient(0deg, rgba(13,74,22,0.5) 0%, rgba(32,145,49,0.5) 100%)'
            />
            <AcademyCard
                ...
                image='/testing.jpg'
                bg='rgb(4,68,94)'
                bgGradient='linear-gradient(0deg, rgba(4,68,94,0.5) 0%, rgba(15,99,136,0.5) 100%)'
            />
        </Row>
    )
}
