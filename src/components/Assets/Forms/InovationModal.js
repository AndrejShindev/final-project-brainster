...
const InovationModal = () =>{
    const {showInovationModal, setShowInovationModal} = useContext(MyContext);

    const submitHandler = (e) => {
        e.preventDefault()
    }
    const handleClose = () => {
        setShowInovationModal(false)
    }
    return(
        <div className='InovationModal'>
            <Modal show={showInovationModal} onHide={handleClose}>
